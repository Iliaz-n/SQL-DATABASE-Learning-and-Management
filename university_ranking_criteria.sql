...
--
-- Host: localhost    Database: universityranking
-- ------------------------------------------------------
...
CREATE TABLE `ranking_criteria` (
  ...
  PRIMARY KEY (`id`),
  KEY `ranking_system_id` (`ranking_system_id`),
  CONSTRAINT `ranking_criteria_ibfk_1` FOREIGN KEY (`ranking_system_id`) REFERENCES `ranking_system` (`id`)
...
-- Dump completed on 2024-02-21  6:02:07
